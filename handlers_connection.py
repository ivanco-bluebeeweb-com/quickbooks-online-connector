...
async def connect_quickbooks(ctx, params: ConnectQuickbooksParams) -> ActionResult:
    ...
    return ActionResult.ok(ConsentUrlResult(authorize_url=authorize_url, redirect_uri=redirect_uri))
...
async def disconnect_quickbooks(ctx, params: DisconnectQuickbooksParams) -> ActionResult:
    ...
    return ActionResult.ok(DeleteResult(deleted=True, detail="QuickBooks connection removed."))
